...
let partition = async (array,low,high)=>{
    ...
    for(let j=low;j<high;j++){
        ...
        if(array[j]<pviot){
            ...
            change_color(i,"#4FACF7")
            change_color(j,"#4FACF7")
    }
...
let mergeSort = async (array)=>{
    ...
    if(array.length>1){
        ...
        await set_array_color(array,"#4FACF7")

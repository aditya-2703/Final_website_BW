...
const game_end = ()=>{
    play_audio("/static/other_sound/linkedlist/game_over.wav")
...
class Snake{
    constructor(){
        ...
        this.tail = null
        this.snake_size = 0
        this.audio = new Audio("/static/other_sound/linkedlist/bg.mp3")
    ...
    move_right(){
        ...
        if(is_out_of_boundry("right",this.tail.data)){
            ...
            // ----------- if eat food it grow
            if(new_location === food_location){
                play_audio("/static/other_sound/linkedlist/eat.wav")

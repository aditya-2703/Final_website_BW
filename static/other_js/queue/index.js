let album_data = [
    {
        id: 1,
        image: '/static/other_img/queue/shape_of_you.jpeg',
        name: "Shape of you",
        artist_name: "Ed Sheeran",
        time: '3:22',
        prio: 1,
        path: "/static/other_sound/queue/shape_of_you.mp3"
    },
    {
        id: 2,
        image: '/static/other_img/queue/believer.jpg',
        name: "Believer",
        artist_name: "Imagine Dragons",
        time: '3:11',
        prio: 1,
        path: "/static/other_sound/queue/believer.mp3"
    },
    {
        id: 3,
        image: '/static/other_img/queue/fairy_tale.webp',
        name: "Fairy tale",
        artist_name: "Alexander Rybak",
        time: '2:56',
        prio: 2,
        path: "/static/other_sound/queue/fairy_tail.mp3"
    },
    {
        id: 4,
        image: '/static/other_img/queue/old_town_road.png',
        name: "Old town road",
        artist_name: "Lil Nas X",
        time: '2:22',
        prio: 31,
        path: "/static/other_sound/queue/old_town.mp3"
    },
    {
        id: 5,
        image: '/static/other_img/queue/devil_eyes.webp',
        name: "Devil eyes",
        artist_name: "Hippie Sabotage",
        time: '3:00',
        prio: 1,
        path: "/static/other_sound/queue/devil_eyes.mp3"
    },
    {
        id: 6,
        image: '/static/other_img/queue/the_nights.jpg',
        name: "The Nights",
        artist_name: "Avicii - The days",
        time: '4:22',
        prio: 0,
        path: "/static/other_sound/queue/the_nights.mp3"
    },
    {
        id: 7,
        image: '/static/other_img/queue/thrift_shop.jpg',
        name: "Thirft shops",
        artist_name: "The BossHoss",
        time: '4:22',
        prio: 1,
        path: "/static/other_sound/queue/thrift_shop.mp3"
    },
    {
        id: 8,
        image: '/static/other_img/queue/venom.jpg',
        name: "Venom",
        artist_name: "Eminem",
        time: '4:22',
        prio: 1,
        path: "/static/other_sound/queue/venom.mp3"
},
]
...
function show_favorite(){
    ...
    document.querySelector(".show_alb").style.fontWeight = "normal"
    document.querySelector(".album").style.fontWeight = "normal"
    ...
    document.querySelector(".show_fav").style.color = "black"
    document.querySelector(".show_fav").style.fontWeight = "bold"
    ...
    document.querySelector(".fav").style.fontWeight = "bolder"
    document.querySelector(".fav").style.textShadow = "2px 0 0 #fff, -2px 0 0 #fff, 0 2px 0 #fff, 0 -2px 0 #fff, 1px 1px #fff, -1px -1px 0 #fff, 1px -1px 0 #fff, -1px 1px 0 #fff"
...
function show_album(){
    document.querySelector(".show_fav").style.color = "black"
    document.querySelector(".show_fav").style.fontWeight = "normal"
    document.querySelector(".show_alb").style.color = "black"
    document.querySelector(".fav").style.fontWeight = "normal"
    ...
    document.querySelector(".album").style.fontWeight = "bolder"
    document.querySelector(".album").style.textShadow = "2px 0 0 #fff, -2px 0 0 #fff, 0 2px 0 #fff, 0 -2px 0 #fff, 1px 1px #fff, -1px -1px 0 #fff, 1px -1px 0 #fff, -1px 1px 0 #fff"
...
function normal_mode(){
    ...
    document.querySelector(".normal_m").style.fontWeight = "normal"
    document.querySelector(".circular_m").style.fontWeight = "normal"
    document.querySelector(".priority_m").style.fontWeight = "normal"
...
function priority_mode(){
    ...
    // document.querySelector(".priority_m_img").src = "https://api.isconify.design/ant-design/ordered-list-outlined.svg?color=%2339FF14"

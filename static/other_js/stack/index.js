...
const init_start = ()=>{
    play_music("/static/other_sound/stack/game_start_music.wav")
...
class Main{
    ...
    game_start = ()=>{
        ...
        img.src="/static/other_img/stack/player1.png"
    ...
    change_card(player1){
        document.getElementById("player1_card").src = "/static/other_img/stack/player1.png"
        document.getElementById("player2_card").src=  "/static/other_img/stack/player2.png"
        

        // player 1 is active
        if(player1){
            document.getElementById("player1_card").src = "/static/other_img/stack/"+this.card_obj_list[this.player1_peep()][0]
        }
        // player2 is active
        else{
            document.getElementById("player2_card").src= "/static/other_img/stack/"+this.card_obj_list[this.player2_peep()][0]
        }

        setTimeout(()=>{
            if(this.floor.length>0){
                document.getElementById("img_board").src = "/static/other_img/stack/"+this.card_obj_list[this.floor_peep()][0]
                if(player1){
                    document.getElementById("player1_card").src = "/static/other_img/stack/player1.png"
                }
                // player2 is active
    ...
    action_same_card(player1){
        ...
        play_music("/static/other_sound/stack/same_card.wav")
    ...
    game_end(player1){
        ...
        play_music("/static/other_sound/stack/game_end.wav")
        ...
        win_gif.src = "/static/other_img/stack/party.gif"
...
const action = ()=>{
    ...
    play_music("/static/other_sound/stack/start_click.wav")

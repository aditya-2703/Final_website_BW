...
function play(arg) {
    if (arg=="win"){
        var audio = new Audio('/static/other_sound/string/win.wav');
    }
    else{
        var audio = new Audio('/static/other_sound/string/type.wav');
    }
    audio.play();
}
...
game_end = (right,wrong,arr,total_time)=>{
    ...
    document.querySelector(".typed_input_cont").style.display="none"
